const homeData = {
  en: {
    hero: {
      title: 'A community for the development of Pashto',
      description:
        'Our mission is to create a vibrant community of volunteers and contributors who are dedicated to the development and adoption of the Pashto language',
  ...
  ps: {
    ...
    links: [
      ...
      {
        title: 'پروژې',
        description: `دلته د پښتو ټولنې لخوا د اوسنيو پروژو لیست دی:`,
        imgSrc: '/static/images/time-machine.jpg',
        href: '/projects',
      },
      {
        title: 'بلاګ',
        description: `د پښتو ټولنې له تازه خبرونو او تازه معلوماتو سره اوسئ`,
        imgSrc: '/static/images/google.png',
        href: '/blog',
      },
      {
        title: 'زموږ په اړه',
        description: `زموږ هدف دا دی چې په ډیجیټل محصولاتو کې د پښتو ژبې غوره کولو ته وده ورکولو لپاره یوه ټولنه رامینځته کړو`,
        imgSrc: '/static/images/time-machine.jpg',
        href: '/about',
      },
    ],
